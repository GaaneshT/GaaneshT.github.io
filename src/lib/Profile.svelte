<script>
    ...
    let about_me = `
        ...
        I'm also an Undergraduate Teaching Assistant at NUS, guiding students in security concepts. 
    ...
    let skills = [
    "Penetration Testing", "Vulnerability Assessment", "Incident Response", "Digital Forensics", "Malware Analysis & Reverse Engineering",
];
